...
class ConfigLoader:
    ...
    def apply_globals(self):
        ...
        if g is None:
            return None
        import physics.vec as _vec
        import bodies.body as _bodies
        import physics.world as _world
        _vec.G = g
        _bodies.G = g
        _world.G = g
        try:
            import physics.reference_frames as _rf
            _rf.NEWTONIAN_G = g
        except Exception:
            pass
        return g
    ...
    def apply_to_renderer(self, renderer):
        ...
        self._assign(renderer, 'renderer', [
            ...
            ('orbit_line_samples_per_period', 'orbit_line_samples_per_period', float),
            ('orbit_line_max_track_samples', 'orbit_line_max_track_samples', int),
            ('orbit_line_max_periods_drawn', 'orbit_line_max_periods_drawn', float),
