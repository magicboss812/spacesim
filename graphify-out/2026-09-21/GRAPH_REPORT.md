...
Cohesion: 0.25
Nodes (4): Fenster, GL-context und der frame-takt. Stand als erste 70 zeilen von `main()`…, Einen frame abwarten und das ECHTE delta in sekunden liefern., Das SDL/OpenGL-fenster und die uhr, die den frame-takt vorgibt., Window
